...
Make sure to follow a template for the PR description if the repo has one.
...
Open a draft PR rather than a real PR. If the user also asked to babysit it, continue with the 'babysit-pr' skill.
