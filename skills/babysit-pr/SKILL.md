...
The repos we work in may have various AI review bots. They're helpful, even if they are not always right.
...
Keep an eye on changes to `main' and merge back when needed. If an overlapping PR makes this one obsolete, stop monitoring, report it to the user, and ask before closing the PR unless closure was explicitly authorized.
...
Don't answer to human review comments unless the user explicitly asked you to. Instead, gather context and ask for the my input.
